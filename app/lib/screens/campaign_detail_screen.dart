      ...
      child: GlassCard(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 10),
            Text('Since ${c.startDate != null ? U.dateFull(c.startDate!) : '—'}', style: const TextStyle(color: C.textMuted, fontSize: 11)),
            const Spacer(),
            // TOGGLE
            GestureDetector(
              onTap: () {
...
if (adSet.targeting.locations != null && adSet.targeting.locations!.isNotEmpty)
  _targetRow('📍', adSet.targeting.locations!.join(', ')),
if (adSet.targeting.interests != null && adSet.targeting.interests!.isNotEmpty)

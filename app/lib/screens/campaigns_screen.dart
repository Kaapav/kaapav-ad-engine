...
class _CampaignsScreenState extends State<CampaignsScreen>
  ...
  List<Campaign> get _filtered {
    ...
    if (_objectiveFilter != 'All') {
      list = list
          .where((c) => K.objectives[c.objective] == _objectiveFilter)
          .toList();
    }
            ...
            builder: (_, __) => Container(
              decoration: BoxDecoration(
                gradient: RadialGradient(
                  center: Alignment(
                      0.5 - _bgC.value * 0.4, -0.6 + _bgC.value * 0.3),
                  radius: 1.5,
                  colors: [
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Manage your Meta ad campaigns',
                    style:
      ...
      child: GlassCard(
        ...
        child: Row(
          ...
          children: [
            ...
            Container(width: 1, height: 28, color: C.glassBorder),
            _summaryItem('Avg ROAS', U.roas(avgRoas),

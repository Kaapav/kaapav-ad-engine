...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  final _roasData = <double>[
    2.8, 3.0, 3.2, 3.5, 3.3, 3.8, 4.0, 3.9, 4.2, 3.8,
    4.1, 3.9, 4.3, 4.5, 4.2, 4.0, 4.4, 4.6, 4.3, 4.8,
    4.5, 4.2, 4.6, 4.9, 4.7, 4.5, 4.8, 5.1, 4.9, 5.2,
  ];
            ...
            builder: (_, __) => Container(
              decoration: BoxDecoration(
                gradient: RadialGradient(
                  center: Alignment(
                      -0.5 + _bgC.value * 0.3, -0.8 + _bgC.value * 0.2),
                  radius: 1.5,
                  colors: [
...
onRefresh: () async {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: C.primary.withValues(alpha: 0.4), blurRadius: 12)
              ],
            ),
            child:
          ...
          children: [
            ...
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Budget Alert: 2 campaigns near daily limit',
                      style: TextStyle(
                          color: C.textPrimary,
                          fontSize: 11,
                          fontWeight: FontWeight.w600)),
                  Text('Auto-scale enabled • Increasing by 15%',
                      style:
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  _miniKpi(
                      'Revenue', '₹6.45L', C.success, Icons.trending_up),
  ...
  Widget _topCampaigns() {
    return Padding(
      ...
      child: Column(
        children: [
          SectionHeader(title: 'Top Campaigns', action: 'View All', onAction: () => context.go('/campaigns')),
          const SizedBox(height: 10),
          ...[
            const CampaignTile(
  ...
  Widget _insightCard(
      IconData icon, Color color, String title, String subtitle, String action) {
    return GlassCard(
      radius: 16,
